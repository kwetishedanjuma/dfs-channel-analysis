...
│
├── src/                              # Resuable python modules for .py scripts
│   ├── __init__.py                   # Package initialisation
│   ├── data_loader.py                # Load system .xlxs data files from ../data/
│   ├── profile_analysis.py           # LOWESS smoothing functions for channel gradients
│   ├── trend_analysis.py             # OLS regression functions (R², p-value, CV)
