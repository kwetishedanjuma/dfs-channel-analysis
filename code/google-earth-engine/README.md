...
## Purpose
These scripts provide essential data acquisition capabilities for the manual digitization workflow, ensuring complete spatial coverage and appropriate elevation data for all study systems.
...
- Google Earth Engine account with access to:
  ...
  - Arctic DEM (for polar systems)
  - Sentinel-2 MSI Surface Reflectance
- Study area boundaries (typically channel belt extent + buffer)

## Workflow Integration
1. **Define study area**: Use manually digitized channel belt boundaries
...
4. **Import to ArcGIS**: Use outputs in manual digitization workflow
...
- No automated classification - supports manual digitization approach only
